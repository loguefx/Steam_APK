...
public class ContainerManager {
    ...
    /**
     * Game Hub–style: ensure a container exists so the user can "just add a game."
     * If no container exists, creates one named "Default" asynchronously and passes it to the callback.
     */
