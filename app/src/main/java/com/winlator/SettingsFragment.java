...
public class SettingsFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        final EditText etSteamApiKey = view.findViewById(R.id.ETSteamApiKey);
        etSteamApiKey.setText(new SteamAuthPrefs(context).getWebApiKey());
        ...
        view.findViewById(R.id.BTSignOut).setOnClickListener((v) -> {
            new SteamAuthPrefs(context).signOut();
        ...
        view.findViewById(R.id.BTConfirm).setOnClickListener((v) -> {
            ...
            new SteamAuthPrefs(context).setWebApiKey(etSteamApiKey.getText() != null ? etSteamApiKey.getText().toString().trim() : "");
