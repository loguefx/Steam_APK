    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.main_menu_input_controls:
                ...
                break;
            case R.id.main_menu_components:
                show(new ComponentsFragment());
                break;
            case R.id.main_menu_compatibility:
                show(new CompatibilityFragment());
                break;
            case R.id.main_menu_cloud_config:
                show(new CloudConfigFragment());
                break;
            case R.id.main_menu_offline:
                show(new OfflineModeFragment());
                break;
            case R.id.main_menu_translation_params:
                show(new TranslationParamsFragment());
                break;
            case R.id.main_menu_device:
                show(new DeviceFragment());
                break;
