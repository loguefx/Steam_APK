        ...
        private void showListItemMenu(View anchorView, final Shortcut shortcut) {
            ...
            listItemMenu.setOnMenuItemClickListener((menuItem) -> {
                ...
                if (itemId == R.id.shortcut_settings) {
                    ...
                    com.winlator.gamehubpp.GameProfileState state = store.getOrCreateGameState(gameId, "profile_safe_v1");
                    boolean newPinned = !state.pinned;
                    store.setPinned(gameId, newPinned);
                    android.widget.Toast.makeText(context, newPinned ? R.string.pin_lkg_for_offline : R.string.unpin_lkg, android.widget.Toast.LENGTH_SHORT).show();
                    loadShortcutsList();
                }
